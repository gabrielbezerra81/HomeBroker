    ...
    <div className="containerMapaCalor">
      {seletorMapaCalor !== "semcor" && faixasMapaCalor ? (
        <div className="faixasTemperatura">
          <div>{faixasMapaCalor[3].max}</div>
          <div>{faixasMapaCalor[3].min}</div>
          <div>{faixasMapaCalor[2].min}</div>
          <div>{faixasMapaCalor[1].min}</div>
        </div>
      ) : null}
      {seletorMapaCalor !== "semcor" && faixasMapaCalor ? (
        <div className="labelMinMax">{faixasMapaCalor[4].min}</div>
      ) : (
        <div className="divMapaSemCor"></div>
      )}
      <img src={termometro} alt="Mapa de calor"></img>
      {seletorMapaCalor !== "semcor" && faixasMapaCalor ? (
        <div className="labelMinMax">{faixasMapaCalor[0].min}</div>
      ) : (
        <div className="divMapaSemCor"></div>
      )}
      <Radio.Group

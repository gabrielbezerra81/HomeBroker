...
const OrdensExecucao = React.lazy(() =>
  import("components/popups/ordens_em_execucao/OrdensExecucao")
);
const Multileg = React.lazy(() =>
  import("components/popups/multileg_/Multileg")
);
const PosicaoEmCustodia = React.lazy(() =>
  import("components/popups/posicao_custodia/PosicaoEmCustodia")
);
const RelatorioDetalhado = React.lazy(() =>
  import("components/popups/relatorio_detalhado/RelatorioDetalhado")
);
const TelaTHL = React.lazy(() => import("components/popups/thl/Tela_THL"));
